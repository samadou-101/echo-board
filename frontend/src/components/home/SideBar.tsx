...
export const SideBar: React.FC<SideBarProps> = ({
  ...
  return (
    <aside
      className={`fixed inset-y-0 top-16 left-0 h-[calc(100vh-4rem)] w-64 transform border-r border-gray-200 bg-white/70 p-4 shadow-lg backdrop-blur-md transition-all duration-300 max-lg:z-20 sm:px-6 sm:pt-0 lg:static lg:min-w-72 lg:translate-x-0 dark:border-gray-800 dark:bg-gray-900/70 max-lg:dark:bg-gray-950/60 ${
